...
const FiltersBar = ({
  ...
  return (
    <div className="border-8 border-red-500">
      <div
        className={`${
          openFiltersBar ? "h-auto" : "h-12 overflow-hidden"
        } flex flex-col border-2 border-yellow-500 transition-all duration-300`}
      >
        <div className="border-4 border-blue-500">
          <button
            className="bg-purple-500 p-1 border border-black"
            onClick={() => setOpenFiltersBar(!openFiltersBar)}
          >
            Filtros
          </button>
        </div>
        <div className="flex flex-wrap gap-3 bg-gray-100 p-2 md:justify-evenly border-2 border-orange-500">
          {/* All Filters  */}
