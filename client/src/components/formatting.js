...
export const operationColorMap = {
  // Returns Tailwind CSS classes based on the provided operation ID.
  ...
  5: "bg-blue-400 font-semibold px-2 py-1 rounded text-center", // MEDICIÓN
};
